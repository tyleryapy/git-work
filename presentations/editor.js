...
(function () {
  ...
  // Extended for this report: KPIs, block headers, cards, heat table, footers
  var TEXT_SEL = "h1,h2,h3,h4,p,li,blockquote,.kicker,.lede,.t,.d,.lead,.bh,.v,.l,.s,.row,.foot,.warn,.legend,.note-edit,.pain,.st,.sb,.so,.nm,.tv,.l2t,.kh>span:first-child,td.cn,th";
  ...
  function markSlide(slot) {
    slot.querySelectorAll(TEXT_SEL).forEach(function (el) {
      ...
      // Keep this report's specialized UIs (detail matrix + priority list) intact
